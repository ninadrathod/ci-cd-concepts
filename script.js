...
const quizData = {
  ...
  intro: [
    {
      ...
      options: ['Code Inspection', 'Continuous Integration', 'Continuous Inspection', 'Compiled Interface'],
    ...
    },
    {
      ...
      options: ['Code Distribution', 'Continuous Development', 'Continuous Delivery or Continuous Deployment', 'Compiled Distribution'],
      answer: 'C. Continuous Delivery or Continuous Deployment',
    ...
    },
    {
      ...
      answer: 'B. To automate and streamline the process of delivering software changes reliably and quickly',
    ...
    },
    {
      ...
      options: ['Waterfall development model', 'DevOps', 'The Agile Manifesto principles', 'Test-Driven Development (TDD)'],
      answer: 'B. DevOps',
    ...
    },
    {
      ...
      answer: 'C. The "It works on my machine" syndrome — code that works locally but breaks in other environments or for other developers',
    ...
    },
    {
      ...
      answer: 'C. It enables more frequent, smaller, and safer releases — sometimes multiple times per day',
    ...
    },
    {
      ...
      answer: 'B. Painful and time-consuming — developers worked in isolation for weeks/months, then attempted to merge all code together in a chaotic event called "integration hell"',
    ...
    },
    {
      ...
      answer: 'B. A series of automated steps that code passes through, from commit to deployment',
  ...
  'version-control': [
    {
      ...
      answer: 'B. A tool that tracks changes to code over time, allowing collaboration and the ability to revert to any previous state',
    ...
    },
    {
      ...
      answer: 'B. Creates a new empty Git repository in the current directory by creating a hidden .git folder',
    ...
    },
    {
      ...
      answer: 'C. Uploads your local commits to the remote repository (e.g., GitHub), triggering CI/CD pipelines',
    ...
    },
    {
      ...
      answer: 'B. A separate, isolated line of development that diverges from the main codebase without affecting it',
    ...
    },
    {
      ...
      answer: 'B. A situation where Git cannot automatically merge two branches because both modified the same lines of a file in incompatible ways',
    ...
    },
    {
      ...
      answer: 'B. It provides the trigger event (code push/PR) that starts the pipeline, stores pipeline configuration files, and tracks exactly what changed in each run',
    ...
    },
    {
      ...
      answer: 'B. A configuration file listing file/directory patterns that Git should not track — preventing secrets, build artifacts, and noise from being committed',
  ...
  ci: [
    {
      ...
      answer: 'C. Multiple times per day — at minimum once every working day, with small, focused commits',
    ...
    },
    {
      ...
      answer: 'B. The agonizing experience of merging weeks or months of parallel, isolated development — resulting in massive conflicts and broken code that could take longer to fix than to write',
    ...
    },
    {
      ...
      answer: 'B. A dedicated machine or cloud service (GitHub Actions, Jenkins) that monitors the repo and automatically executes build, test, and other pipeline jobs when triggered',
    ...
    },
    {
      ...
      answer: 'C. A build where all automated checks — compile, lint, tests, security scans — completed successfully with zero failures',
    ...
    },
    {
      ...
      answer: 'B. Structuring the pipeline to run cheapest/quickest checks first, detect failures early, and stop subsequent steps when a failure is found',
    ...
    },
    {
      ...
      answer: 'B. Automated notifications (Slack alerts, email, PR comments, dashboards) that keep the team instantly informed about the status of each pipeline run',
    ...
    },
    {
      ...
      answer: 'C. Merging large batches of uncommitted code directly to main without running any automated checks',
  ...
  testing: [
    ...
    },
    {
      ...
      answer: 'B. A model recommending many fast unit tests at the base, a moderate number of integration tests in the middle, and few slow E2E tests at the top — balancing speed, cost, and coverage',
    ...
    },
    {
      ...
      answer: 'B. Tests that verify how two or more components, services, or systems work correctly together — testing their interactions and interfaces',
    ...
    },
    {
      ...
      answer: 'B. A methodology where you write a failing test first, then write only enough code to make it pass, then refactor — the "red-green-refactor" cycle',
    ...
    },
    {
      ...
      answer: 'B. A test that inconsistently passes sometimes and fails other times without any code changes — due to timing issues, external dependencies, or random data',
    ...
    },
    {
      ...
      answer: 'C. Unit tests first (fastest), then integration tests, then E2E tests last (slowest) — fail fast at the cheapest level first',
    ...
    },
    {
      ...
      answer: 'B. A minimal set of quick, broad tests that verify the application\'s most critical functionality works — a basic "does it start and do the main things?" sanity check',
    ...
    },
    {
      ...
      answer: 'C. Tests verifying that previously working functionality still works correctly after new code changes — ensuring new code doesn\'t break old features',
  ...
  build: [
    {
      ...
      answer: 'B. The output files produced by the build process — such as a compiled binary, a JAR file, a Docker image, or a zip archive — ready to be deployed',
    ...
    },
    {
      ...
      answer: 'B. A containerization platform that packages applications and all their dependencies into lightweight, isolated containers that run identically on any machine',
    ...
    },
    {
      ...
      answer: 'B. A storage and distribution service for Docker images — analogous to npm for packages or GitHub for code',
    ...
    },
    {
      ...
      answer: 'B. A versioning standard using MAJOR.MINOR.PATCH — where 2 is the major version (breaking changes), 4 is the minor version (new features), and 1 is the patch version (bug fixes)',
    ...
    },
    {
      ...
      answer: 'B. A text file containing sequential instructions telling Docker exactly how to build a Docker image for your application step-by-step',
    ...
    },
    {
      ...
      answer: 'B. Saving and reusing intermediate build results (like installed dependencies) between separate pipeline runs, dramatically reducing build times',
    ...
    },
    {
      ...
      answer: 'B. Running the build multiple times with identical source code and dependencies always produces byte-for-byte identical output artifacts',
    ...
    },
    {
      ...
      answer: 'B. Creating the artifact a single time in CI and promoting that exact same artifact through all environments (dev → staging → production), never rebuilding for each environment',
    ...
    },
    {
      ...
      answer: 'B. A specialized storage system (JFrog Artifactory, Nexus, AWS CodeArtifact) for storing and distributing versioned build outputs — distinct from GitHub which stores source code',
  ...
  delivery: [
    {
      ...
      answer: 'B. A practice ensuring software is always in a deployable state, with the ability to release to production at any time via an automated pipeline — though the actual release requires deliberate human approval',
    ...
    },
    {
      ...
      answer: 'C. Continuous Delivery requires a manual human approval before production deployment; Continuous Deployment automatically deploys every passing commit to production without human intervention',
    ...
    },
    {
      ...
      answer: 'B. A pre-production environment that closely mirrors production infrastructure, used for final testing and validation before releasing to real users',
    ...
    },
    {
      ...
      answer: 'B. The controlled process of moving (promoting) a tested, approved artifact from one environment to the next: development → staging → production',
    ...
    },
    {
      ...
      answer: 'B. An automated system that defines and orchestrates every step required to take code from version control to running in production — making the delivery process visible, repeatable, and automated',
    ...
    },
    {
      ...
      answer: 'B. A required human review and sign-off step that pauses the pipeline, requiring an authorized person to click "Approve" before it continues to the next stage (typically production)',
    ...
    },
    {
      ...
      answer: 'B. The practice of managing environment-specific settings (database URLs, feature flags, API endpoints) separately from application code, injecting them at deploy time',
    ...
    },
    {
      ...
      answer: 'C. Use a dedicated secrets manager (GitHub Secrets, HashiCorp Vault, AWS Secrets Manager) that stores them encrypted and injects them securely at runtime — never in logs or code',
    ...
    },
    {
      ...
      answer: 'B. A version of the software that has passed all automated CI/CD gates and is considered potentially ready for production release, pending final validation',
    ...
    },
    {
      ...
      answer: 'B. The main branch should always contain working, fully-tested code that could be safely and confidently deployed to production at any moment — not just at planned release times',
  ...
  deployment: [
    {
      ...
      answer: 'B. A fully automated process where every code change that passes all automated quality gates is automatically deployed to production with no human intervention required',
    ...
    },
    {
      ...
      answer: 'B. A configuration switch that allows teams to enable or disable specific application features without deploying new code — decoupling deployment from release',
    ...
    },
    {
      ...
      answer: 'B. A strategy releasing new code to a small percentage of users first — monitoring for errors before gradually expanding to all users. Named after miners who used canary birds as early warning systems for dangerous gas',
    ...
    },
    {
      ...
      answer: 'B. A deployment strategy maintaining two identical production environments (blue=current live, green=new version), switching all traffic from blue to green instantly when ready',
    ...
    },
    {
      ...
      answer: 'B. A strategy that gradually replaces old running instances of the application with new ones, one at a time or in batches, without taking the entire service offline',
    ...
    },
    {
      ...
      answer: 'B. Reverting the application to a previous, known-good version after a bad deployment causes problems in production',
    ...
    },
    {
      ...
      answer: 'B. A deployment approach where the application remains continuously available and responsive to users throughout the entire deployment process, with no service interruption',
    ...
    },
    {
      ...
      answer: 'B. Managing and provisioning infrastructure (servers, networks, databases, load balancers) through machine-readable declarative code files stored in version control — rather than manual GUI clicks',
  ...
  pipeline: [
    {
      ...
      answer: 'B. A logical grouping of related jobs within a pipeline that represents a phase of work (e.g., Build stage, Test stage, Deploy stage) — later stages only run if earlier stages pass',
    ...
    },
    {
      ...
      answer: 'B. Running multiple independent jobs at the same time simultaneously, which significantly reduces total pipeline execution time',
    ...
    },
    {
      ...
      answer: 'B. An event or condition (code push, pull request, scheduled time, manual button, API call) that causes the pipeline to start executing',
    ...
    },
    {
      ...
      answer: 'B. The practice of defining your pipeline configuration in version-controlled files stored alongside application code — rather than configuring pipelines through a web UI',
    ...
    },
    {
      ...
      answer: 'B. A cloud runner is a machine managed and provided by the CI/CD platform (e.g., GitHub\'s Ubuntu machines); a self-hosted runner is a machine you own, configure, and maintain yourself',
    ...
    },
    {
      ...
      answer: 'B. Pipeline caching saves and restores files (dependencies, compiled code) between separate pipeline RUNS; build caching (Docker layer cache) reuses layers within a single build step',
    ...
    },
    {
      ...
      answer: 'B. A pipeline that automatically runs on a configured time schedule (e.g., nightly at 2 AM) regardless of any code changes',
  ...
  tools: [
    {
      ...
      answer: 'B. GitHub\'s built-in CI/CD and workflow automation platform where pipelines are defined in YAML files under `.github/workflows/` and triggered by GitHub events',
    ...
    },
    {
      ...
      answer: 'B. An open-source, self-hosted automation server — the most widely deployed CI/CD tool — with 1,800+ plugins for extensibility and pipelines defined in a Jenkinsfile',
    ...
    },
    {
      ...
      answer: 'C. YAML (YAML Ain\'t Markup Language) with `.yml` or `.yaml` file extension',
    ...
    },
    {
      ...
      answer: 'B. GitLab\'s natively built-in CI/CD system, configured via `.gitlab-ci.yml`, tightly integrated with GitLab\'s repositories, Container Registry, Security scanning, and Environments feature',
    ...
    },
    {
      ...
      answer: 'B. A cloud-native CI/CD platform (with self-hosted option) known for fast parallelism, excellent Docker support, and configuration via `.circleci/config.yml` with reusable "Orbs"',
    ...
    },
    {
      ...
      answer: 'B. A declarative, GitOps continuous delivery tool for Kubernetes that watches Git for changes and automatically syncs the cluster\'s state to match the desired state defined in Git',
    ...
    },
    {
      ...
      answer: 'B. An open-source container orchestration platform that automates deploying, scaling, and managing containerized applications — commonly the target deployment environment for CD pipelines',
    ...
    },
    {
      ...
      answer: 'B. The package manager for Kubernetes — it packages all Kubernetes YAML manifests for an application into versioned, configurable "charts" that can be installed, upgraded, and rolled back with single commands',
    ...
    },
    {
      ...
      answer: 'B. An open-source Infrastructure as Code tool (by HashiCorp) that provisions cloud resources using declarative `.tf` files — often run as pipeline stages for automated infrastructure management',
  ...
  practices: [
    ...
    },
    {
      ...
      answer: 'B. Sensitive configuration values (API keys, passwords, tokens, certificates) that pipelines need at runtime — and must NEVER be hardcoded in source code or printed in logs',
    ...
    },
    {
      ...
      answer: 'B. An automated security testing method that analyzes source code, bytecode, or binaries for security vulnerabilities without actually executing the application',
    ...
    },
    {
      ...
      answer: 'B. An automated security testing method that tests a running application by actively sending malicious inputs and observing responses — simulating real attacker behavior against a live system',
    ...
    },
    {
      ...
      answer: 'B. Deployment Frequency, Lead Time for Changes, Change Failure Rate, and Mean Time to Recovery (MTTR)',
    ...
    },
    {
      ...
      answer: 'B. How often an organization successfully deploys code to production — ranging from less than once per month (low performers) to multiple times per day (elite performers)',
